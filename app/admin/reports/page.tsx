...
const ethicsData: EthicsRow[] = [
  ...
  {
    id: "3",
    requirement: "Ethics Scenarios",
    rate: "60%",
    status: "changes-requested" as RecordStatus,
  },
  {
    id: "4",
    requirement: "Final Assessment",
    rate: "45%",
    status: "assessment-pending" as RecordStatus,
  },
];
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <ChartCard
          title="Practical Experience Completion"
          subtitle="By training year cohort">
          <ResponsiveContainer width="100%" height={300}>
            <BarChart
              ...
              <Bar
                ...
                name="In Progress"
                stackId="a"
                fill={ICAB_PALETTE.clay}
              />
              <Bar
                dataKey="notStarted"
                name="Not Started"
                stackId="a"
                fill={ICAB_PALETTE.petal}
                radius={[4, 4, 0, 0]}
              />
            </BarChart>
          </ResponsiveContainer>
        ...
        <ChartCard
          title="Technical Module Progress"
          subtitle="Pass/fail distribution by core subject">
          <ResponsiveContainer width="100%" height={300}>
            <BarChart
              data={technicalData}
              margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              ...
              <Bar
                ...
                name="Pending"
                stackId="a"
                fill={ICAB_PALETTE.rose}
              />
              <Bar
                dataKey="failed"
                name="Failed"
                stackId="a"
                fill={ICAB_PALETTE.slate}
                radius={[4, 4, 0, 0]}
              />
            </BarChart>
          </ResponsiveContainer>
        ...
        <ChartCard
          ...
          subtitle="Student progression funnel">
          <ResponsiveContainer width="100%" height={300}>
            <FunnelChart>
              <Tooltip />
        ...
        <ChartCard
          title="Ethics Compliance Overview"
          subtitle="Aggregate compliance rates for IES 4 requirements">
