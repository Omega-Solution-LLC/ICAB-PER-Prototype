import { Student, Principal, PracticalExperiencePeriod, TechnicalModule, SkillRecord, EthicsTrainingProgress, EthicsModule, EthicsApplication, AuditEngagement, RecordStatus } from '@/types';
